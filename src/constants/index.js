...
export const clientReviews = [
    {
        ...
        review:
            'TechRavana transformed our project beyond expectations! Their attention to detail and dedication to delivering high-quality work was impressive. We could be happier with the outcome! 😊',
    },
    {
        id: 2,
        name: 'Mark Rogers',
        ...
        review:
            'Working with TechRavana was a game-changer for our website. The team is highly skilled, and their creative approach brought our vision to life seamlessly. Highly recommended! 🚀',
    },
    {
        id: 3,
        name: 'Nandun Perera',
        ...
        review:
            'From start to finish, TechRavana made the process easy and stress-free. Their professionalism and innovative solutions are unmatched. Truly a top-notch experience!',
    },
    {
        id: 4,
        ...
        review:
            'TechRavana නිසා අපගේ ව්‍යාපෘතිය අපේක්ෂාවට වඩා හොඳට ප්‍රතිඵල ලබා ගත්තා! ඔවුන්ගේ දක්ෂතාවය සහ විශිෂ්ට නිර්මාණශීලීත්වය අපිට ගොඩක් සතුටක් ලබා දුන්නා! 💡',
    },
];
...
export const stories = [
    {
        id: 1,
        name: 'Uncovering Your Vision',
        des: 'Workshops & Design Sprints',
        title: "We kick off every project with a series of workshops and design sprints to truly understand the scope and the challenges of your assignments or application. By collaborating closely with you, we dive deep into the core issues, gaining valuable insights to frame the solution in a way that meets your expectations",
        icon: '/assets/light-bulb.svg',
        animation: 'salute',
    },
    {
        id: 2,
        name: "Mapping Your Project's Journey",
        des: 'Tailored Roadmaps',
        title: "We create detailed roadmaps that outline the development journey of your project. Whether it's a personal website or a mobile application, we define the steps clearly so you can see where your project is headed, ensuring transparency and clear milestones throughout the process",
        icon: '/assets/light-bulb-second.svg',
        animation: 'clapping',
    },
    {
        id: 3,
        name: 'Collaborating for Excellence',
        des: 'Connect and Co-Create',
        title: "At TechRavana, we believe that collaboration is key to building successful solutions. We work closely with you at every stage of development, encouraging co-creation to bring your ideas to life. Our iterative process ensures that your feedback is incorporated, delivering a product that not only meets but exceeds expectations",
        icon: '/assets/light-bulb.svg',
        animation: 'victory',
    },
];
...
export const works = [
    {
        name: "Culture and Tourism System - Kolama",
        description:
            "An e-commerce related web application that allows users to search, buy, order and manage Sri Lankan heritage arts (kolams, masks, puppets) to promote culture and tourism, promote Sri Lankan arts to the world",
        image: '/assets/kolama.png',
    },
    {
        name: "Ticketing System for Transport Network",
        description:
            "A new web application for public transport in Sri Lanka introduces a digital ticketing system to address issues with traditional protocols. The system uses the Distance Matrix API to calculate ticket fares",
        image: '/assets/easy.png',
    },
    {
        name: "Space Management System - SpaceShri",
        description:
            "SpaceShri is a web application designed to establish a space management system in Sri Lanka, similar to NASA in the US. The application features departments for managing rocket launches and projects",
        image: '/assets/space.png',
    },
    {
        name: "Food Donation Mobile Application - KillHunger",
        description:
            "KillHunger is an app designed to support sustainable development goals under the Zero Hunger initiative. In response to global crises such as the COVID-19 pandemic, the app aims to address hunger-related issues",
        image: '/assets/food.png',
    },
    {
        name: "Health Care Mobile Application - Care",
        description:
            "A mobile app called Care teaches people how to live a healthy life. An Android app has been developed for users and they can select the types of news, tips and tricks, health zones and health equipment for their needs",
        image: '/assets/health.webp',
    },
    {
        name: "Machine Learning Based Car Price Predictor",
        description:
            "This is a Flask web application that predicts the price of a car based on various features using a Decision Tree Regressor machine learning model. A model file trained using machine learning is used to run the application",
